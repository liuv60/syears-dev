...
public class STPersonArticleEntity {
    @Id
    ...
    public void setFactdate(String factdate) {
        this.factdate = factdate == null ? null : factdate.trim();
    }
    ...
    public void setReadpower(String readpower) {
        this.readpower = readpower == null ? null : readpower.trim();
    }
    ...
    public void setArticlelook(String articlelook) {
        this.articlelook = articlelook == null ? null : articlelook.trim();
    }
    ...
    public void setReplaceman(String replaceman) {
        this.replaceman = replaceman == null ? null : replaceman.trim();
    }
    ...
    public Integer getRefnums() {
        return refnums;
    }

    public void setRefnums(Integer refnums) {
